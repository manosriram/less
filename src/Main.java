    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Article article: articles) {
            ...
            if (Objects.equals(article.infosegment.getTitle(), "homepage")) {
                ...
                writer.write(g.ArticleTemplate().replace("{title}", article.infosegment.getTitle()).replace("{content}", article.contentsegment.getContent()));
                writer.write(article.contentsegment.getContent());
